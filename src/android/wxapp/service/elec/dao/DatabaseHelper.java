...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String SQL_ORGE_CREATE_TABLE = "create table " + TB_ORG
			+ " (" + FIELD_ORG_ID + " integer primary key autoincrement, "
			+ FIELD_ORG_ORG_CODE + " text," + FIELD_ORG_ORG_NAME + " text,"
			+ FIELD_ORG_REMARK + " text," + FIELD_ORG_UPDATE_TIME + " text)";
	...
	public static final String SQL_PERSON_CREATE_TABLE = "create table "
			+ TB_PERSON + " (" + FIELD_PERSON_ID
			+ " integer primary key autoincrement, " + FIELD_PERSON_ALIAS
			+ " text," + FIELD_PERSON_ORG_CODE + " text," + FIELD_PERSON_NAME
			+ " text," + FIELD_PERSON_CONTACT + " text,"
			+ FIELD_PERSON_IDENTIFY_CODE + " text," + FIELD_PERSON_REMARK
			+ " text," + FIELD_PERSON_IMSI + " text,"
			+ FIELD_PERSON_FORCE_OFFLINE + " text," + FIELD_PERSON_SEQUENCE
			+ " text," + FIELD_PERSON_UPDATE_TIME + " text)";
	...
	public static final String SQL_ROLE_CREATE_TABLE = "create table "
			+ TB_ROLE + " (" + FIELD_ROLE_ID
			+ " integer primary key autoincrement, " + FIELD_ROLE_NAME
			+ " text," + FIELD_ROLE_REMARK + " text," + FIELD_ROLE_UPDATE_TIME
			+ " text)";
	...
	public static final String SQL_ROLE_PERSON_CREATE_TABLE = "create table "
			+ TB_ROLE_PERSON + " (" + FIELD_ROLE_PERSON_ID
			+ " integer primary key autoincrement, " + FIELD_ROLE_PERSON_PID
			+ " text," + FIELD_ROLE_PERSON_RID + " text)";
	...
	public static final String SQL_PERMISSION_CREATE_TABLE = "create table "
			+ TB_PERMISSION + " (" + FIELD_PERMISSION_ID
			+ " integer primary key autoincrement, "
			+ FIELD_PERMISSION_MENU_CODE + " text," + FIELD_PERMISSION_CODE
			+ " text," + FIELD_PERMISSION_NAME + " text,"
			+ FIELD_PERMISSION_ROLE_ID + " text)";
	...
	public static final String SQL_LOG_CREATE_TABLE = "create table " + TB_LOG
			+ " (" + FIELD_LOG_ID + " integer primary key autoincrement, "
			+ FIELD_LOG_USER_NAME + " text," + FIELD_LOG_TYPE + " text,"
			+ FIELD_LOG_CONTENT + " text," + FIELD_LOG_TIME + " text,"
			+ FIELD_LOG_LONGITUDE + " text," + FIELD_LOG_LATITUDE + " text,"
			+ FIELD_LOG_CLIENT + " text," + FIELD_LOG_IP + " text)";
	...
	public static final String SQL_DIC_CREATE_TABLE = "create table "
			+ TB_DICTIONARY + " (" + FIELD_DIC_ID
			+ " integer primary key autoincrement, " + FIELD_DIC_CODE
			+ " text," + FIELD_DIC_NAME + " text)";
	...
	public static final String SQL_DIC_DATA_CREATE_TABLE = "create table "
			+ TB_DIC_DATA + " (" + FIELD_DICDATA_ID
			+ " integer primary key autoincrement, " + FIELD_DICDATA_DATA_CODE
			+ " text," + FIELD_DICDATA_DATA_VALUE + " text,"
			+ FIELD_DICDATA_DICTIONARY_CODE + " text)";
	...
	public static final String SQL_TASK_CREATE_TABLE = "create table "
			+ TB_TASK + " (" + FIELD_TASKINFO_ID
			+ " integer primary key autoincrement, " + FIELD_TASKINFO_WEATHER
			+ " text," + FIELD_TASKINFO_NAME + " text,"
			+ FIELD_TASKINFO_POWER_CUT_RANGE + " text,"
			+ FIELD_TASKINFO_EFFECT_EARA + " text," + FIELD_TASKINFO_CONTENT
			+ " text," + FIELD_TASKINFO_RESPONSIBILITY_USER + " text,"
			+ FIELD_TASKINFO_PLAN_START_TIME + " text,"
			+ FIELD_TASKINFO_PLAN_END_TIME + " text,"
			+ FIELD_TASKINFO_START_TIME + " text," + FIELD_TASKINFO_END_TIME
			+ " text," + FIELD_TASKINFO_CATEGORY + " text,"
			+ FIELD_TASKINFO_IS_PUBLISH + " text," + FIELD_TASKINFO_SPECIAL
			+ " text," + FIELD_TASKINFO_LEADER + " text,"
			+ FIELD_TASKINFO_MEASURES + " text," + FIELD_TASKINFO_DOMAIN
			+ " text," + FIELD_TASKINFO_IS_POWER_CUT + " text,"
			+ FIELD_TASKINFO_CUT_TYPE + " text," + FIELD_TASKINFO_IMPLEMENT_ORG
			+ " text," + FIELD_TASKINFO_NUMBER + " text,"
			+ FIELD_TASKINFO_REMARK + " text," + FIELD_TASKINFO_TASK_CODE
			+ " text," + FIELD_TASKINFO_PLAN_TYPE + " text,"
			+ FIELD_TASKINFO_CREATOR_ID + " text,"
			+ FIELD_TASKINFO_RESPONSIBILITY_USER_ID + " text,"
			+ FIELD_TASKINFO_CREATOR_TIME + " text," + FIELD_TASKINFO_IS_KEEP
			+ " text," + FIELD_TASKINFO_LEADER_ID + " text,"
			+ FIELD_TASKINFO_STATUS + " text," + FIELD_TASKINFO_EXAMINE_ID
			+ " text," + FIELD_TASKINFO_IMPLEMENT_ORG_ID + " text,"
			+ FIELD_TASKINFO_APPROVE_ID + " text," + FIELD_TASKINFO_UPDATE_ID
			+ " text," + FIELD_TASKINFO_UPDATE_TIME + " text)";
	...
	public static final String SQL_TASK_STANDARD_CREATE_TABLE = "create table "
			+ TB_TASK_STANDARD + " (" + FIELD_TASK_STANDARD_ID
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_STANDARD_STANDARD + " text,"
			+ FIELD_TASK_STANDARD_TOTAL_SCORE + " text,"
	...
	public static final String SQL_TASK_EVALUATE_CREATE_TABLE = "create table "
			+ TB_TASK_EVALUATE + " (" + FIELD_TASK_EVALUATE_ID
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_EVALUATE_TASK_ID + " text,"
			+ FIELD_TASK_EVALUATE_STANDARD_ID + " text,"
			+ FIELD_TASK_EVALUATE_SCORE + " text,"
			+ FIELD_TASK_EVALUATE_EVALUATE + " text,"
			+ FIELD_TASK_EVALUATE_USER_ID + " text," + FIELD_TASK_EVALUATE_TIME
			+ " text)";
	...
	public static final String SQL_TASK_ATTACHMENT_CREATE_TABLE = "create table "
			+ TB_TASK_ATTACHMENT
			+ " ("
			+ FIELD_TASK_ATTCHMENT_ID
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_ATTCHMENT_TASK_ID
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_HISTORYGPS
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_STANDARD
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_TYPE
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_URL
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_UPLOAD_TIME
			+ " text,"
			+ FIELD_TASK_ATTCHMENT_MD5 + " text)";
	...
	public static final String SQL_TASK_INSTRUCTIONS_CREATE_TABLE = "create table "
			+ TB_TASK_INSTRUCTIONS
			+ " ("
			+ FIELD_TASK_INSTRUCTIONS_ID
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_INSTRUCTIONS_TASK_ID
			+ " text,"
			+ FIELD_TASK_INSTRUCTIONS_CONTENT
			+ " text,"
			+ FIELD_TASK_INSTRUCTIONS_SEND_ID
			+ FIELD_TASK_INSTRUCTIONS_TYPE
			+ " text,"
			+ " text,"
			+ FIELD_TASK_INSTRUCTIONS_SEND_TIME
			+ " text)";
	...
	public static final String SQL_TASK_INSTRUCTIONS_RECEIVE_CREATE_TABLE = "create table "
			+ TB_TASK_INSTRUCTIONS_RECEIVE
			+ " ("
			+ FIELD_TASK_INSTRUCTIONS_RECIEVE_ID
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_INSTRUCTIONS_RECIEVE_INSTRUCTIONS_ID
			+ " text,"
			+ FIELD_TASK_INSTRUCTIONS_RECIEVE_RECEIVE_ID
			+ " text,"
			+ FIELD_TASK_INSTRUCTIONS_RECIEVE_RECEIVE_TIME
			+ " text,"
	...
	public static final String SQL_TASK_INS_ATT_CREATE_TABLE = "create table "
			...
			+ " integer primary key autoincrement, "
			+ FIELD_TASK_INS_ATT_INSTRUCTIONS_ID + " text,"
			+ FIELD_TASK_INS_ATT_TYPE + " text," + FIELD_TASK_INS_ATT_URL
			+ " text," + FIELD_TASK_INS_ATT_UPDATE_TIME + " text,"
			+ FIELD_TASK_INS_ATT_MD5 + " text)";
	...
	public static final String SQL_SYS_GROUP = "create table "
			+ TB_SYS_GROUP + " (" + FIELD_SYS_GROUP_ID
			+ " integer primary key autoincrement, " + FIELD_SYS_GROUP_TYPE
			+ " text," + FIELD_SYS_GROUP_NAME + " text,"
			+ FIELD_SYS_GROUP_CREATE_TIME + " text,"
	...
	public static final String SQL_SYS_GROUP_MEMBER = "create table "
			+ TB_SYS_GROUP_MEMBER + " (" + FIELD_SYS_GROUP_MEMBER_ID
			+ " integer primary key autoincrement, "
			+ FIELD_SYS_GROUP_MEMBER_GROUP_ID + " text,"  + FIELD_SYS_GROUP_MEMBER_PERSON_ID + " text)";
	...
	public static final String SQL_SYS_MESSAGE = "create table "
			+ TB_SYS_GROUP_MEMBER + " (" + FIELD_SYS_MESSAGE_ID
			+ " integer primary key autoincrement, "
			+ FIELD_SYS_MESSAGE_TYPE + " text," 
			+ FIELD_SYS_MESSAGE_SENDER_ID + " text," 
			+ FIELD_SYS_MESSAGE_RELATION_ID + " text," 
			+ FIELD_SYS_MESSAGE_SEND_TIME + " text," 
			+ FIELD_SYS_MESSAGE_CONTENT + " text," 
			+ FIELD_SYS_MESSAGE_UPDATE_TIME + " text)";
	...
	//人员类型表
		...
		public static final String SQL_SYS_PERSON_TYPE = "create table "
				+ TB_SYS_GROUP_MEMBER + " (" + FIELD_SYS_PERSON_TYPE_ID
				+ " integer primary key autoincrement, "
		...
		public static final String SQL_SYS_MESSAGE_PERSON = "create table "
				+ TB_SYS_GROUP_MEMBER + " (" + FIELD_SYS_MESSAGE_PERSON_ID
				+ " integer primary key autoincrement, "
				+ FIELD_SYS_MESSAGE_PERSON_MESSAGE_ID + " text," 
				+ FIELD_SYS_MESSAGE_PERSON_RELATOR_ID + " text," 
				+ FIELD_SYS_MESSAGE_PERSON_IS_READ + " text," 
				+ FIELD_SYS_MESSAGE_PERSON_TYPE + " text," 
				+ FIELD_SYS_MESSAGE_PERSON_UPDATE_TIME + " text)";
	...
	public static final String SQL_GPS_HISTORY_CREATE_TABLE = "create table "
			+ TB_GPS_HISTORY + " (" + FIELD_GPS_HISTORY_ID
			+ " integer primary key autoincrement, "
			+ FIELD_GPS_HISTORY_PERSON_ID + " text,"
			+ FIELD_GPS_HISTORY_OLLECTIONTIME + " text,"
			+ FIELD_GPS_HISTORY_LONGITUDE + " text,"
			+ FIELD_GPS_HISTORY_LATITUDE + " text,"
			+ FIELD_GPS_HISTORY_GPS_TYPE + " text,"
			+ FIELD_GPS_HISTORY_ACCURACY + " text," + FIELD_GPS_HISTORY_HEIGHT
			+ " text," + FIELD_GPS_HISTORY_SPEED + " text,"
			+ FIELD_GPS_HISTORY_UPDATE_TIME + " text,"
			+ FIELD_GPS_HISTORY_COORDINATE + " text,"
