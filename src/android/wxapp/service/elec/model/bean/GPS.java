...
public class GPS {
	...
	public GPS(String person_id, String ollectionTime, String longitude,
			String latitude, String gps_type, String accuracy, String height,
			String speed, String update_time, String coordinate, String remark) {
		super();
		this.person_id = person_id;
		this.ollectionTime = ollectionTime;
		this.longitude = longitude;
