...
//	public static int SCHEDULE_PORT = 5060;
	...
	public static String SERVER_URL = "http://" + Contants.SERVER + ":" + Contants.PORT
			+ File.separator;
	// 模块名称
	...
	public static final String TONGJI_METHOD = "supervise/dayBrowerPerday.do?";
	public static final String TONGJI_PARAM = "loginParameter=";
